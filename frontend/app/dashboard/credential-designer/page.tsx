            ...
            <div className="modal-body" style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-2 max-h-48 overflow-y-auto">
                  ...
                  >
                    <div className={`font-medium ${!selectedPreset ? 'text-primary-700 dark:text-primary-200' : 'text-text-primary'}`}>Blank</div>
                    <div className={`text-xs ${!selectedPreset ? 'text-primary-500 dark:text-primary-400' : 'text-text-tertiary'}`}>Start fresh</div>
                  </button>
                  {presets.map((preset) => (
                    <button
                      key={preset.id}
                    ...
                    >
                      <div className={`font-medium ${selectedPreset?.id === preset.id ? 'text-primary-700 dark:text-primary-200' : 'text-text-primary'}`}>{preset.name}</div>
                      <div className={`text-xs ${selectedPreset?.id === preset.id ? 'text-primary-500 dark:text-primary-400' : 'text-text-tertiary'}`}>{preset.category}</div>
                    </button>
                  ))}
                </div>
              </div>
