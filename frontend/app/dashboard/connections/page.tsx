          ...
          <table className="table">
            ...
            <tbody>
              {sortedConnections.map((connection, idx) => {
                ...
                return (
                  <tr key={connection.id} className="cdp-row" style={{ cursor: 'pointer' }} onClick={() => router.push(`/dashboard/connections/${connection.id}`)}>
                    <td>
                    ...
                    <td style={{ textAlign: 'right' }}>
                      <div style={{ display: 'flex', gap: 4, justifyContent: 'flex-end', alignItems: 'center' }}>
                        ...
                        <button onClick={(e) => { e.stopPropagation(); router.push(`/dashboard/connections/${connection.id}`); }} className="btn btn-secondary btn-xs">View</button>
                      </div>
                    </td>
                  </tr>
                );
